...
final class ReleaseReadinessTests: XCTestCase {
    func testCanonicalAppMetadataMatchesV1_3_1AndExistingSparkleTrustKey() throws {
        ...
        XCTAssertEqual(metadata["CFBundleShortVersionString"] as? String, "1.3.1")
        XCTAssertEqual(metadata["CFBundleVersion"] as? String, "1301")
